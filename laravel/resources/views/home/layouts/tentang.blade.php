		...
		<div class="container">
			...
			<div class="navbar-collapse w-100 collapse" id="navbarCollapse">
				...
				<ul class="navbar-nav navbar-nav-scroll mx-auto">
					...
					<li class="nav-item">
						<a class="nav-link " href="/liga" id="demoMenu" data-bs-toggle=""  aria-haspopup="true" aria-expanded="false">Liga</a>
					</li>
					<li class="nav-item ">
						<a class="nav-link " href="www.berita.bisabola.id" id="demoMenu" data-bs-toggle="" aria-haspopup="true" aria-expanded="false">Berita</a>
					</li>
