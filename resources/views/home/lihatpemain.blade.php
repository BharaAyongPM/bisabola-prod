                            ...
                            <div class="col d-md-flex justify-content-between align-items-center mt-4">
                                <div>
                                    ...
                                    <ul class="list-inline mb-0">
                                        ...
                                        <li class="list-inline-item h6 fw-light me-3 mb-1 mb-sm-0"><i class="fas fa-user-graduate text-orange me-2"></i>{{ $player->tanggal_lahir->format('Y') }}</li>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="row g-4">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" type="text" value="{{ $player->berat }} KG" readonly>
                                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive border-0">
                                        ...
                                        <table class="table table-dark-gray align-middle p-4 mb-0 table-hover">
                                            ...
                                            <tbody>
                                                <!-- Table item -->
                                                <tr>@foreach ($statistik as $statistic)
                                                    <!-- Table data -->
                                                    <td>
                                                        <h6 class="table-responsive-title mt-2 mt-lg-0 mb-0"><a href="#">{{ $statistic->musim ?? '0' }}</a></h6>
                                                    </td>

                                                    <!-- Table data -->
                                                    <td class="text-center text-sm-start text-primary-hover">
                                                        <a href="#" class="text-body"><u>{{ $statistic->kompetisi ?? '0' }}</u></a>
                                                    </td>
                                                    ...
                                                    <!-- Table data -->
                                                    <td>{{ $statistic->gol ?? '0'}}</td>

                                                    <!-- Table data -->
                                                    <td>{{ $statistic->asist ?? '0'}}</td>

                                                    <td>{{ $statistic->kartu_kuning ?? '0'}} / {{ $statistic->kuning_kuning ?? '0'}}/ {{ $statistic->kartu_merah?? '0' }}</td>

                                                    <!-- Table data -->
                                                    <td>{{ $statistic->tahun?? '0' }}</td>
                                                </tr>@endforeach
                                            </tbody>
                                            <!-- Table body END -->
                                        </table>
