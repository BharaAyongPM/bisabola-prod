		...
		<div class="container">
			...
			<div class="navbar-collapse w-100 collapse" id="navbarCollapse">
				...
				<ul class="navbar-nav navbar-nav-scroll mx-auto">
                    ...
                    <li class="nav-item ">
						<a class="nav-link " href="/coach" id="demoMenu" data-bs-toggle="" aria-haspopup="true" aria-expanded="false">Pelatih</a>
					</li>
					<li class="nav-item ">
					...
					<li class="nav-item ">
						<a class="nav-link " href="http://berita.bisabola.id" target="_blank" id="demoMenu" data-bs-toggle="" aria-haspopup="true" aria-expanded="false">Berita</a>
					</li>
					<li class="nav-item ">
