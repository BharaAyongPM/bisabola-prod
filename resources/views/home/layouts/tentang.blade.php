...
<html lang="en">
<head>
	<title>Tentang Kami - Bisabola</title>
	...
	<nav class="navbar navbar-expand-xl">
		<div class="container">
			...
			<a class="navbar-brand" href="index.html">
				<img class="light-mode-item navbar-brand-item" src="assets/img/logoku.png" alt="logo">
			...
			<div class="navbar-collapse w-100 collapse" id="navbarCollapse">
				...
				<ul class="navbar-nav navbar-nav-scroll mx-auto">
					...
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="/pemain" id="demoMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Pemain</a>

					</li>
					<li class="nav-item ">
						<a class="nav-link " href="/galeri" id="demoMenu" data-bs-toggle="" aria-haspopup="true" aria-expanded="false">Galeri</a>
					</li>
					<li class="nav-item ">
						<a class="nav-link " href="/club" id="demoMenu" data-bs-toggle="" aria-haspopup="true" aria-expanded="false">Klub</a>
					</li>
					<li class="nav-item">
						<a class="nav-link " href="/liga.html" id="demoMenu" data-bs-toggle=""  aria-haspopup="true" aria-expanded="false">Liga</a>
					</li>
                    <li class="nav-item ">
						<a class="nav-link " href="/jadwal" id="demoMenu" data-bs-toggle="" aria-haspopup="true" aria-expanded="false">Jadwal</a>
					</li>
					<li class="nav-item ">
						<a class="nav-link " href="http://www.berita.bisabola.id" target="_blank" id="demoMenu" data-bs-toggle="" aria-haspopup="true" aria-expanded="false">Berita</a>
					</li>
					<li class="nav-item active">
						<a class="nav-link active" href="/tentang" id="demoMenu" data-bs-toggle="" aria-haspopup="true" aria-expanded="false">Tentang</a>
					</li>
					<li class="nav-item ">
		...
		<div class="row g-4">
			...
			<div class="col-lg-5 col-md-12">
				...
				<a class="me-0" href="index.html">
					<img class="light-mode-item h-40px" src="assets/img/logoku.png" alt="logo">
