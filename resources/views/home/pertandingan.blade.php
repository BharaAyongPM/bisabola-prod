			...
			<div class="col-12">
				<div class="row align-items-center">
					...
					<div class="col-md-6 px-md-5 text-center position-relative order-md-2 mb-5 mb-md-0">
						...
						<!-- Title -->
						<h1 class="mb-3">Informasi Liga</h1>
						<p class="mb-3"></p>
					</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-8 mb-2 mb-lg-4 position-relative">
				...
				<!-- Title -->
				<h1 class="display-4 mb-3 mb-lg-0">{{ $league->nama_liga }}</h1>
			</div>

			<!-- Info and buttons -->
			<div class="col-lg-5 mb-4 mb-lg-0">
				<p class="mb-4">{{ $league->des }}
                    </p>
				<!-- Buttons -->
				...
				<div class="row g-4">
					...
					<div class="col-md-6">
						<div class="d-flex align-items-center">
							...
							<div class="ms-3">
								<div class="d-flex">
									<h4 class="purecounter fw-bold mb-0" data-purecounter-start="0" data-purecounter-end="25" data-purecounter-delay="200">{{ $league->jumlah_club }}</h4>
									<span class="h4 mb-0">+</span>
								</div>
								<div>Klub</div>
							</div>
			...
			<div class="col-lg-7">
				<div class="position-relative">
                    ...
                    @if ($league->poster)
					<!-- Image -->
					<img src="{{ asset('storage/poster/' . $league->poster) }}" class="rounded-3" alt="">
                    @else
...
<section>
	<div class="container">
		...
		<div class="row mb-4 mx-auto text-center">
			<div class="col-12">
				<h2 class="mb-0">Pertandingan</h2>
			</div>
		</div>
        <div class="col-9 mx-auto ">
			<!-- Tabs START -->
			<ul class="nav nav-pills nav-pills-bg-soft px-3 text-center" id="book-pills-tab" role="tablist">
			    <!-- Tab item -->
				<li class="nav-item me-2 me-sm-4" role="presentation">
					<button class="nav-link mb-0 active" id="book-pills-tab-1" data-bs-toggle="pill" data-bs-target="#book-pills-1" type="button" role="tab" aria-controls="book-pills-1" aria-selected="true">Klasemen</button>
				</li>
				<!-- Tab item -->
				<li class="nav-item me-2 me-sm-4" role="presentation">
					<button class="nav-link mb-0" id="book-pills-tab-2" data-bs-toggle="pill" data-bs-target="#book-pills-2" type="button" role="tab" aria-controls="book-pills-2" aria-selected="false">Jadwal</button>
				</li>
				<!-- Tab item -->
				<li class="nav-item me-2 me-sm-4" role="presentation">
					<button class="nav-link mb-0" id="book-pills-tab-3" data-bs-toggle="pill" data-bs-target="#book-pills-3" type="button" role="tab" aria-controls="book-pills-3" aria-selected="false">Top Skor</button>
				</li>
			</ul>
			<!-- Tabs END -->
			<!-- Tab contents START -->
                                ...
                                <table class="table table-dark-gray align-middle p-4 mb-0">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="border-0">Nama Tim</th>
                                            <th scope="col" class="border-0">T</th>
                                            <th scope="col" class="border-0">M</th>
                                            <th scope="col" class="border-0">S</th>
                                            <th scope="col" class="border-0">K</th>
                                            <th scope="col" class="border-0 rounded-end">Poin</th>
                                        </tr>
                                    </thead>
                                    <!-- Table body START -->
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <!-- Image -->
                                                    <div class="w-60px">
                                                        <img src="assets/images/pemain/Persita/aditya_harlan.jpg" class="rounded" alt="">
                                                    </div>
                                                    <!-- Title -->
                                                    <h6 class="mb-0 ms-2 table-responsive-title">
                                                        <a href="#">Bali United</a>
                                                    </h6>
                                                </div>
                                            </td>
                                            <!-- Selling item -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <!-- Image -->
                                                    <div class="w-60px">
                                                        <img src="assets/images/pemain/Persita/andika_r.jpg" class="rounded" alt="">
                                                    </div>
                                                    <!-- Title -->
                                                    <h6 class="mb-0 ms-2 table-responsive-title">
                                                        <a href="#">Persis Solo</a>
                                                    </h6>
                                                </div>
                                            </td>
                                            <!-- Selling item -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <!-- Image -->
                                                    <div class="w-60px">
                                                        <img src="assets/images/pemain/Persita/cristian_r.jpg" class="rounded" alt="">
                                                    </div>
                                                    <!-- Title -->
                                                    <h6 class="mb-0 ms-2 table-responsive-title">
                                                        <a href="#">Barito Putera</a>
                                                    </h6>
                                                </div>
                                            </td>
                                            <!-- Selling item -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <!-- Image -->
                                                    <div class="w-60px">
                                                        <img src="assets/images/pemain/Persita/javlon_g.jpg" class="rounded" alt="">
                                                    </div>
                                                    <!-- Title -->
                                                    <h6 class="mb-0 ms-2 table-responsive-title">
                                                        <a href="detail_pemain.html">RANS Nusantara</a>
                                                    </h6>
                                                </div>
                                            </td>
                                            <!-- Selling item -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <!-- Image -->
                                                    <div class="w-60px">
                                                        <img src="assets/images/pemain/Persita/rendy-oscario.jpg" class="rounded" alt="">
                                                    </div>
                                                    <!-- Title -->
                                                    <h6 class="mb-0 ms-2 table-responsive-title">
                                                        <a href="#">Dewa United</a>
                                                    </h6>
                                                </div>
                                            </td>
                                            <!-- Selling item -->
                            ...
                            <div class="col-md-6 col-lg-4">
                                ...
                                <div class="card bg-transparent">
                                    <div class="overflow-hidden rounded-3">
                                        <img src="assets/images/event/02.jpg" class="card-img" alt="Card image">
                                        <!-- Overlay -->
                                        <div class="bg-overlay bg-dark opacity-4"></div>
                                        <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                            <!-- badge -->
                                            <a href="#" class="badge bg-danger text-white">Bali United</a>
                                        </div>
                                    </div>
                                    <!-- Card body -->
                            ...
                            <div class="col-md-6 col-lg-8">
                                <div class="row g-4">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="card bg-transparent">
                                            <div class="overflow-hidden rounded-3">
                                                <img src="assets/images/vs.jpg" class="card-imgp" alt="Card image">
                                            </div>
                                            <!-- Card body -->
                                            <div class="card-body px-3 text-center">
                                                <!-- Title -->
                                                <h6 class="card-title text-center"><a href="#">Rabu, 24 Agustus 2023</a></h6>
                                                <h6 class="mb-0 text-center"><a href="#">16:00 WIB</a></h6>
                                                <p class="text-truncate-2 text-center">Std Manahan Solo </p>
												<a href="detail_pertandingan.html" class="btn btn-sm btn-danger mb-0 text-center">Detail Pertandingan</a>
                                            </div>
                                        </div>
                                        <!-- Card item END -->
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="card bg-transparent">
                                            <div class="overflow-hidden rounded-3">
                                                ...
                                                <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                                    <!-- badge -->
                                                    <a href="#" class="badge bg-purple text-white">Persis Solo</a>
                                                </div>
                                            </div>
                                            <!-- Card body -->
                                            <div class="card-body px-3">
					...
					<div class="row">
						<div class="col-4 col-sm-3">
						  <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
							<a class="nav-link active" id="v-pills-home-tab" data-bs-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">Goal</a>
							<a class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">Assist</a>
							<a class="nav-link" id="v-pills-messages-tab" data-bs-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false">Clean Sheet</a>
							<a class="nav-link" id="v-pills-settings-tab" data-bs-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false">Kartu Kuning</a>
							<a class="nav-link" id="v-pills-red-tab" data-bs-toggle="pill" href="#v-pills-red" role="tab" aria-controls="v-pills-settings" aria-selected="false">Kartu Merah</a>
						  </div>
						</div>
										...
										<table class="table table-dark-gray align-middle p-4 mb-0 table-hover">
											...
											<thead>
												<tr>
													...
													<th scope="col" class="border-0">Goal</th>
												</tr>
											</thead>
												...
												<tr>
													...
													<td>
														<div class="d-flex align-items-center">
															...
															<div class="mb-0 ms-2">
																<!-- Title -->
																<h6><a href="#">Bambang Pamungkas</a></h6>
															</div>
														</div>
													</td>
													<!-- Enrolled item -->
													<td class="text-center text-sm-start">Persija Jakarta</td>
													<!-- Status item -->
													<td class="text-center text-sm-start">12</td>
													<!-- Action item -->
												</tr>
										...
										<table class="table table-dark-gray align-middle p-4 mb-0 table-hover">
											...
											<thead>
												<tr>
													<th scope="col" class="border-0 rounded-start">Nama Pemain</th>
													<th scope="col" class="border-0">Klub</th>
													<th scope="col" class="border-0">Assist</th>
												</tr>
											</thead>
										...
										<table class="table table-dark-gray align-middle p-4 mb-0 table-hover">
											...
											<thead>
												<tr>
													<th scope="col" class="border-0 rounded-start">Nama Pemain</th>
													<th scope="col" class="border-0">Klub</th>
													<th scope="col" class="border-0">Clean Sheet</th>
												</tr>
											</thead>
										...
										<table class="table table-dark-gray align-middle p-4 mb-0 table-hover">
											...
											<thead>
												<tr>
													<th scope="col" class="border-0 rounded-start">Nama Pemain</th>
													<th scope="col" class="border-0">Klub</th>
													<th scope="col" class="border-0">Kartu Kuning</th>
												</tr>
											</thead>
										...
										<table class="table table-dark-gray align-middle p-4 mb-0 table-hover">
											...
											<thead>
												<tr>
													<th scope="col" class="border-0 rounded-start">Nama Pemain</th>
													<th scope="col" class="border-0">Klub</th>
													<th scope="col" class="border-0">Kartu Merah</th>
												</tr>
											</thead>
