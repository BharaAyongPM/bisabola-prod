				...
				<div class="row g-4">
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							<!-- Image -->
							@if ($league->poster)
							<img src="{{ asset('storage/poster/' . $league->poster) }}" class="card-img-top" alt="course image">
							@else
							...
							<div class="card-body pb-0">
								...
								<!-- Title -->
								<h5 class="card-title"><a href="{{ route('lihatliga', $league->id) }}">{{ $league->nama_liga }}</a></h5>
								<!-- Rating star -->
								<p>{{ $league->penyelenggara }}</p>
							</div>
							<!-- Card footer -->
							<div class="card-footer pt-0 pb-3">
								...
								<div class="d-flex justify-content-between">
									...
									<span class="h6 fw-light mb-0"><i class="fas fa-table text-orange me-2"></i>{{ $league->jumlah_club }} Klub</span>
								</div>
							</div>
						</div>
					</div>
