        ...
        <div class="row g-4">
          <!-- Title and SVG START -->
                <div class="col-10 text-center mx-auto position-relative">
                    ...
                    <!-- Title -->
                    <h1 class="position-relative fs-2">Bisabola.id untuk digitalisasi klub bolamu menjadi lebih efisien, efektif dan terkini.</h1>
                </div>
            <!-- Title and SVG END -->
            </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-sm-6 col-md-12">
                            <div class="bg-grad rounded-4 p-5 text-start">
                                <span class="text-white">Visi Kami:</span>
                                <h5 class="text-white">“Menjadi mitra terpercaya dan inovatif dalam meningkatkan pengelolaan dan pengembangan
                                     sepak bola di Indonesia melalui solusi teknologi yang canggih.”</h5>
                            </div>
                        </div>
                        <!-- Image -->
    ...
    <section class="pt-0 pt-md-5">
        <div class="container">
            ...
            <div class="row mb-4">
                <div class="col-lg-8">
                    <h2>Bisabola.id</h2>
                    <p class="mb-0">BisaBola.id berkomitmen untuk memberikan kontribusi yang berarti dalam meningkatkan pengelolaan klub/liga sepak bola di Indonesia dan memperkuat ekosistem sepak bola secara keseluruhan melalui teknologi dan inovasi.</p>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 mt-4 mt-lg-0">
                    <ul class="nav nav-tabs mb-3">
                        <li class="nav-item"> <a class="nav-link active" data-bs-toggle="tab" href="#tab-1-1"> Misi Bisabola.id  </a> </li>
                        <li class="nav-item"> <a class="nav-link" data-bs-toggle="tab" href="#tab-1-2"> Tujuan Bisabola.id</a> </li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane show active" id="tab-1-1">
                            <ul class="list-group list-group-borderless mt-4">
                                <li class="list-group-item d-flex">
                                    <i class="bi bi-patch-check-fill text-success me-2"></i>Menghadirkan solusi teknologi canggih yang dirancang khusus untuk memenuhi kebutuhan klub dan liga sepak bola,
                                    membantu mereka beradaptasi dengan perkembangan tren terbaru di dunia olahraga.
                                </li>
                                <li class="list-group-item d-flex">
                                    <i class="bi bi-patch-check-fill text-success me-2"></i>Mempermudah dan meningkatkan efisiensi operasional klub dan liga dengan mengotomatisasi tugas-tugas administratif, serta menyediakan alat analisis data yang dapat diandalkan.
                                </li>
                                <li class="list-group-item d-flex">
                                    <i class="bi bi-patch-check-fill text-success me-2"></i>Menghubungkan klub, pemain, pelatih, dan penggemar dalam ekosistem yang berinteraksi, memfasilitasi komunikasi dan pertukaran informasi yang bermanfaat.
                                </li>
                                <li class="list-group-item d-flex">
                                    <i class="bi bi-patch-check-fill text-success me-2"></i>Memberikan alat yang mendukung pengembangan bakat sepak bola lokal dengan membantu identifikasi, pelatihan, dan pemantauan pemain muda berpotensi.
                                </li>
                                <li class="list-group-item d-flex">
                                    <i class="bi bi-patch-check-fill text-success me-2"></i>Berkolaborasi dengan berbagai pihak, termasuk klub, asosiasi, dan pihak terkait lainnya, untuk membangun ekosistem sepak bola yang lebih kuat dan berdaya tahan.
                                </li>
                            </ul>
                        </div>
                        <div class="tab-pane" id="tab-1-2">
                            <ul class="list-group list-group-borderless mt-4">
                                <li class="list-group-item d-flex">
                                    <i class="bi bi-patch-check-fill text-success me-2"></i>Menjadi pilihan utama bagi klub dan liga sepak bola dalam mengadopsi solusi teknologi yang handal dan inovatif.
                                </li>
                                <li class="list-group-item d-flex">
                                    <i class="bi bi-patch-check-fill text-success me-2"></i> Mendorong transformasi digital dalam industri sepak bola di Indonesia, merangkul kemajuan teknologi untuk meningkatkan efisiensi dan kualitas.
                                </li>
                                <li class="list-group-item d-flex">
                                    <i class="bi bi-patch-check-fill text-success me-2"></i>Membantu klub dan liga mencapai prestasi lebih tinggi melalui manajemen yang lebih baik, analisis data yang mendalam, dan pengembangan pemain yang berfokus.
                                </li>
                                <li class="list-group-item d-flex">
                                    <i class="bi bi-patch-check-fill text-success me-2"></i> Meningkatkan keterlibatan dan kesetiaan penggemar melalui pengalaman digital yang menarik dan berinteraksi.
                                </li>
                                <li class="list-group-item d-flex">
                                    <i class="bi bi-patch-check-fill text-success me-2"></i>Berperan dalam meningkatkan citra dan prestise sepak bola Indonesia secara nasional dan internasional.
                                </li>
                                <li class="list-group-item d-flex">
                                    <i class="bi bi-patch-check-fill text-success me-2"></i>Memberdayakan olahraga sepak bola lokal dengan menyediakan alat untuk identifikasi dan pengembangan bakat muda dari berbagai daerah.
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="d-sm-flex justify-content-sm-between">
                        <h2 class="mb-0">Tim Bisabola.id</h2>
                    </div>
                    ...
                    <div class="tiny-slider arrow-round arrow-creative arrow-blur arrow-hover mt-2 mt-sm-5">
                        <div class="tiny-slider-inner" data-autoplay="true" data-arrow="true" data-dots="false" data-items="4" data-items-lg="3" data-items-md="2">
                            ...
                            <div class="text-center">
                                ...
                                <!-- Info -->
                                <h6 class="mb-0"><a href="#">Ardi Baramuli</a></h6>
                                <p class="mb-0 small">Owner</p>
                            </div>
                            ...
                            <div class="text-center">
                                ...
                                <!-- Info -->
                                <h6 class="mb-0"><a href="#">Nanda Pratama</a></h6>
                            ...
                            <div class="text-center">
                                ...
                                <!-- Info -->
                                <h6 class="mb-0"><a href="#">Bhara Ayong PM</a></h6>
                                <p class="mb-0 small">Junior Web Developer</p>
                            </div>
                            ...
                            <div class="text-center">
                                ...
                                <!-- Info -->
                                <h6 class="mb-0"><a href="#">Zuli Priadi</a></h6>
                                <p class="mb-0 small">Junior Web Developer</p>
                            </div>
                            ...
                            <div class="text-center">
                                ...
                                <!-- Info -->
                                <h6 class="mb-0"><a href="#">Lia Mawarni</a></h6>
