...
<main>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="bg-dark p-4 text-center rounded-3">
                        <h1 class="text-white m-0">Pelatih</h1>
                        <!-- Breadcrumb -->
    ...
    <section class="pt-4">
        <div class="container">
            ...
            <div class="row mb-4 align-items-center">
                ...
                {{-- <div class="col-sm-6 col-xl-4"> --}}
                    {{-- <form action="{{ route('pemain') }}" method="GET" class="border rounded p-2">
                        <div class="input-group input-borderless">
                            <div class="form-group">
                                <input type="text" name="search" class="form-control" placeholder="Cari pemain...">
                            </div>
        ...
        <div class="form-group">
            <input type="number" name="birth_year" class="form-control" placeholder="Tahun Kelahiran">
        </div>
        <div class="input-group-append">
            <button type="submit" class="btn btn-primary mb-0 rounded"><i class="fas fa-search"></i></button>
        </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive border-0 rounded-3">
                                ...
                                <table class="table table-dark-gray align-middle p-4 mb-0">
                                    ...
                                    <thead>
                                        <tr>
                                            <th scope="col" class="border-0 rounded-start">Nama Pelatih</th>
                                            <th scope="col" class="border-0">ALamat</th>
                                            <th scope="col" class="border-0">Klub</th>
                                            <th scope="col" class="border-0">Kode Pelatih</th>

                                        </tr>
                                    </thead>
                                    <!-- Table body START -->
                                    <tbody>
                                        <!-- Table item -->  @foreach ($pelatih as $p)
                                        <tr>
                                            <!-- Course item -->
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <!-- Image -->
                                                    <div class="w-60px">
                                                        <img src="{{ asset('storage/foto_pemain/' . $p->foto) }}" class="rounded" alt="">
                                                    </div>
                                                    <!-- Title -->
                                                    <h6 class="mb-0 ms-2 table-responsive-title">
                                                        <a href="{{ route('lihatpemain', $p->id) }}">{{ $p->nama }}</a>
                                                    </h6>
                                                </div>
                                            </td>
                                            <!-- Selling item -->
                                            ...
                                            <!-- Period item -->
                                            <td>
                                                <span class="badge bg-primary bg-opacity-10 text-primary">{{ $p->kode_pelatih }}</span>
                                            </td>
                                            <!-- Action item -->
                                            <td>
                                                {{-- {{ $player->kota }} --}}
                                    ...
                                    <ul class="pagination pagination-sm pagination-primary-soft d-inline-block d-md-flex rounded mb-0">
                                        ...
                                        @if ($players->previousPageUrl())
                                            <li class="page-item mb-0">
                                                <a class="page-link" href="{{ $players->previousPageUrl() }}" tabindex="-1"><i class="fas fa-angle-left"></i></a>
                                            </li>
                                        @endif --}}

                                        <!-- Nomor Halaman -->
                                        {{-- @for ($i = 1; $i <= $players->lastPage(); $i++)
                                            <li class="page-item mb-0 {{ $i === $players->currentPage() ? 'active' : '' }}">
                                        ...
                                        {{-- @if ($players->nextPageUrl())
                                            <li class="page-item mb-0">
                                                <a class="page-link" href="{{ $players->nextPageUrl() }}"><i class="fas fa-angle-right"></i></a>
                                            </li>
                                        @endif
                                    </ul> --}}
                                {{-- </nav> --}}
