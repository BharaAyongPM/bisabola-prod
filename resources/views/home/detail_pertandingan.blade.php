			...
			<div class="col-sm-6 col-lg-4 col-xl-4">
				<div class="card bg-transparent text-center">
					<div class="overflow-hidden rounded-3">
						<img src="assets/images/klub/1.png" class="card-img-top" alt="course image" style="width: 300px; height: auto;">
						<div class="card-img-overlay d-flex align-items-start p-3">
							<!-- badge -->
							<!-- <a href="#" class="badge bg-primary text-white">Persita Tangerang</a> -->
						</div>
					</div>
					<!-- Card body -->
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<!-- Image -->
											<div class="w-60px">
												<img src="{{ asset('assets/images/pemain/Persita/andika_r.jpg') }}" class="rounded" alt="">
											</div>
											<!-- Title -->
											<h6 class="mb-0 ms-2 table-responsive-title">
												<a href="#">Aditya Harlan</a>
											</h6>
										</div>
									</td>
									<!-- Amount item -->
									...
									<!-- Period item -->
									<td>
										<span class="badge bg-primary bg-opacity-10 text-primary">01</span>
									</td>
								</tr>
								<tr>
									<!-- Course item -->
									...
									<!-- Period item -->
									<td>
										<span class="badge bg-primary bg-opacity-10 text-primary">04</span>
									</td>
								</tr>
							</tbody>
						</table>
